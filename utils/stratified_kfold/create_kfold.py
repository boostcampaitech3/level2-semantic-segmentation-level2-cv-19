...
def loop_n_split(n):
    stratified_path = '/opt/ml/input/data/stratified_kfold'
    for i in range(n):
        update_dataset(
            index=i,
            mode="train",
...
if __name__ == "__main__":
    os.makedirs('/opt/ml/input/data/stratified_kfold', exist_ok=True)
    parser = argparse.ArgumentParser()
    parser.add_argument("--path", "-p", type=str, default='/opt/ml/input/data/stratified_kfold')
